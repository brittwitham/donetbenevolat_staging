...
À l’échelle nationale, les institutions gouvernementales à but non lucratif (hôpitaux, certains établissements de soins pour bénéficiaires internes, universités et collèges) produisent environ trois quarts du PIB total du secteur sans but lucratif. Le quart restant revient aux organismes du sous-secteur de base. Le ratio est d’environ 3:2 entre les organismes communautaires et les institutions commerciales à but non lucratif. 
                    ...
                    html.Span('''
Ces dernières jouent un rôle économique dominant dans presque toutes les provinces et les territoires (la seule exception étant le Nunavut). De même, les organismes communautaires représentent une proportion plus élevée du PIB que les institutions commerciales à but non lucratif dans tout le pays, sauf au Nouveau-Brunswick et à Terre-Neuve-et-Labrador. 
                    ''', className='mt-4'),
                    ...
                    html.Ol([
                        ...
                        html.Li(
                            [
                                ...
                                html.P(
                                    [
                                        "Les organismes communautaires et les institutions commerciales à but non lucratif  sont regroupés dans le ",
