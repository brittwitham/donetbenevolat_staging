...
def FutureOptimism(df, title, var):
    ...
    fig_FutureOptimism.add_trace(go.Bar(y=df[var],
                                        x=df['S_pessimistic'],
                                        name="Plutôt pessimiste",
                                        marker=dict(color="#50a684"),
                                        legendrank=2,
                                        text=df['S_pessimistic']*-1,
                                        texttemplate="%{text:.0%}",
                                        textposition='inside',
                                        insidetextanchor='middle',
                                        meta=df['S_pessimisticStat'],
                                        hovertemplate="%{text:.1%}"+"<br>Data quality: "+"%{meta}",
                                        orientation='h'))
    ...
    fig_FutureOptimism.add_trace(go.Scatter(y=df[var],
                                            x=df['pessimistic'],
                                            mode='markers+text',
                                            showlegend=False,
                                            name="Pessimiste",
    ...
    for j in range(5): # col num
        for i in range(3): # row nums
            ...
            fig_FutureFacet.add_trace(go.Bar(x=this_df['valNA'],
                                            ...
                                            hovertemplate="%{text:.0%}" + "<br>Data quality: " + "%{meta}",
