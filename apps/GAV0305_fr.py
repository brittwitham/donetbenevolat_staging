...
data = [SubSecAvgDon_2018, SubSecDonRates_2018, SubSecDonRatesFoc_2018, ArtRecDonorsBarriers_2018, ArtRecDonorsDonMeth_2018, ArtRecDonorsDonRates_2018, ArtRecDonorsMotivations_2018, ArtRecVolsActivities_2018, ArtRecVolsBarriers_2018, ArtRecVolsMotivations_2018, ArtRecVolsVolRates_2018, SubSecAvgHrs_2018, SubSecVolRates_2018, SubSecVolRatesFoc_2018]
process_data(data)
...
navbar = gen_navbar("giving_and_volunteering_for_arts_and_recreation_organizations_2018")
   ...
   dbc.Container([
       dbc.Row([
            ...
            html.Div([
                ...
                dcc.Graph(id="ArtRecDonRateDemo_fr", style={'marginTop': marginTop})
            ], className='col-md-10 col-lg-8 mx-auto'
            ),
            # html.Div([
            ...
            html.Div([
               html.H4("Qui fait du bénévolat"),
                ...
                html.Div([
                 ...
                 dcc.Graph(id="ArtRecVolRateDemo_fr", style={'marginTop': marginTop})
            ],  className='col-md-10 col-lg-8 mx-auto'
                     ),
            # html.Div([
            #     html.H4('Support for other organization types'),
