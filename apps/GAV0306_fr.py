...
from utils.graphs.GAV0306_graph_utils import triple_horizontal_rate_avg, triple_vertical_graphs_pops
# from utils.data.GAV0306_data_utils import get_data, process_data, process_rates, get_region_names, get_region_values
...
NewCanadiansAvgDonByCause_2018 = get_dataframe("2018-NewCanadiansAvgDonByCause_FR.csv")
NewCanadiansAvgDonByMeth_2018 = get_dataframe("2018-NewCanadiansAvgDonByMeth_FR.csv")
NewCanadiansAvgHrs_2018 = get_dataframe("2018-NewCanadiansAvgHrs_FR.csv")
NewCanadiansAvgHrsByActivity_2018 = get_dataframe("2018-NewCanadiansAvgHrsByActivity_FR.csv")
NewCanadiansAvgHrsByCause_2018 = get_dataframe("2018-NewCanadiansAvgHrsByCause_FR.csv")
NewCanadiansAvgHrsCommInvolve_2018 = get_dataframe("2018-NewCanadiansAvgHrsCommInvolve_FR.csv")
NewCanadiansAvgHrsHelpDirectly_2018 = get_dataframe("2018-NewCanadiansAvgHrsHelpDirectly_FR.csv")
NewCanadiansBarriers_2018 = get_dataframe("2018-NewCanadiansBarriersGiving_FR.csv")
NewCanadiansBarriersVol_2018 = get_dataframe("2018-NewCanadiansBarriersVol_FR.csv")
NewCanadiansCommInvolveRate_2018 = get_dataframe("2018-NewCanadiansCommInvolveRate_FR.csv")
NewCanadiansDonRateByCause_2018 = get_dataframe("2018-NewCanadiansDonRateByCause_FR.csv")
NewCanadiansDonRateByMeth_2018 = get_dataframe("2018-NewCanadiansDonRateByMeth_FR.csv")
NewCanadiansDonRates_2018 = get_dataframe("2018-NewCanadiansDonRates_FR.csv")
NewCanadiansEfficiencyConcerns_2018 = get_dataframe("2018-NewCanadiansEfficiencyConcerns_FR.csv")
NewCanadiansHelpDirectlyRate_2018 = get_dataframe("2018-NewCanadiansHelpDirectlyRate_FR.csv")
NewCanadiansReasonsGiving_2018 = get_dataframe("2018-NewCanadiansReasonsGiving_FR.csv")
NewCanadiansReasonsVol_2018 = get_dataframe("2018-NewCanadiansReasonsVol_FR.csv")
NewCanadiansSolicitationConcerns_2018 = get_dataframe("2018-NewCanadiansSolicitationConcerns_FR.csv")
NewCanadiansVolRateByActivity_2018 = get_dataframe("2018-NewCanadiansVolRateByActivity_FR.csv")
NewCanadiansVolRateByCause_2018 = get_dataframe("2018-NewCanadiansVolRateByCause_FR.csv")
    ...
    dbc.Container([
        dbc.Row([
            html.Div([
                ...
                # Total, secular and religious donation rates and average donation amounts
                dcc.Graph(id='NewCanadiansDonRateAmt_fr', style={'marginTop': marginTop}),
            ...
            html.Div([
                ...
                dcc.Graph(id='NewCanadiansDonRateByCause_fr', style={'marginTop': marginTop}),
                ...
                dcc.Graph(id='NewCanadiansAvgAmtByCause_fr', style={'marginTop': marginTop}),
            ], className='col-md-10 col-lg-8 mx-auto'),
            html.Div([
                ...
                dcc.Graph(id='NewCanadiansDonRateByMeth_fr', style={'marginTop': marginTop}),
               dcc.Markdown("""
                ...
                dcc.Graph(id='NewCanadiansAvgAmtByMeth_13', style={'marginTop': marginTop}),
            ], className='col-md-10 col-lg-8 mx-auto'
            ),
            html.Div([
                ...
                dcc.Graph(id='NewCanadiansMotivations_13', style={'marginTop': marginTop}),
                # Average amount donated by method
            ], className='col-md-10 col-lg-8 mx-auto'
            ),
            html.Div([
               html.H4('Freins à donner davantage'),
                ...
                dcc.Graph(id='NewCanadiansBarriers_13', style={'marginTop': marginTop}),
                html.Div([
                    ...
                    dcc.Graph(id='NewCanadiansEfficiency_13', style={'marginTop': marginTop}),
                ]),
                html.Div([
                    ...
                    """),
                    dcc.Graph(id='NewCanadiansSolicitations_13', style={'marginTop': marginTop}),
        ...
        dbc.Row([
            html.Div([
                ...
                dcc.Graph(id='NewCanadiansVolRateVolAmt_fr', style={'marginTop': marginTop}),
            ], className='col-md-10 col-lg-8 mx-auto'
            ),
            html.Div([
                ...
                dcc.Graph(id='NewCanadiansVolRateByCause_fr', style={'marginTop': marginTop}),
               dcc.Markdown("""
                ...
                dcc.Graph(id='NewCanadiansAvgHrsByCause_fr', style={'marginTop': marginTop}),
            ], className='col-md-10 col-lg-8 mx-auto'),
            html.Div([
               html.H4('Activités des bénévoles'),
                ...
                dcc.Graph(id='NewCanadiansVolRateByActivity_fr', style={'marginTop': marginTop}),
                dcc.Markdown("""
                ...
                dcc.Graph(id='NewCanadiansAvgHrsByActivity_fr', style={'marginTop': marginTop}),
            ], className='col-md-10 col-lg-8 mx-auto'
            ),
            html.Div([
                ...
                dcc.Graph(id='NewCanadiansVolMotivations_fr', style={'marginTop': marginTop}),
            ], className='col-md-10 col-lg-8 mx-auto'
            ),
            html.Div([
                ...
                dcc.Graph(id='NewCanadiansVolBarriers_fr', style={'marginTop': marginTop}),
            ], className='col-md-10 col-lg-8 mx-auto'
            ),
            html.Div([
               html.H4('Aide directe d’autrui '),
                ...
                dcc.Graph(id='NewCanadiansRateHelpDirect_fr', style={'marginTop': marginTop}),
                dcc.Markdown("""
                ...
                dcc.Graph(id='NewCanadiansHrsHelpDirect_fr', style={'marginTop': marginTop}),
            ], className='col-md-10 col-lg-8 mx-auto'
            ),
            html.Div([
                ...
                dcc.Graph(id='NewCanadiansRateCommInvolve_fr', style={'marginTop': marginTop}),
                 dcc.Markdown("""
                ...
                dcc.Graph(id='NewCanadiansHrsCommInvolve_fr', style={'marginTop': marginTop}),
            ], className='col-md-10 col-lg-8 mx-auto'
            ),
        ]),
    ]),
...
def update_graph(region):
    ...
    name3 = "Non canadien.ne"
    title = '{}, {}'.format(
        "Taux et nombre moyen d'heures consacrées au bénévolat, à l'aide d'autrui<br>et à l'engagement communautaire", region)
