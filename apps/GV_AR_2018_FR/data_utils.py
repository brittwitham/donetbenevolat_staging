...
def get_data():
    ...
    ArtRecDonorsBarriers_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-ArtRecDonorsBarriers_FR.csv")))
    ArtRecDonorsDonMeth_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-ArtRecDonorsDonMeth_FR.csv")))
    ArtRecDonorsDonRates_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-ArtRecDonorsDonRates_FR.csv")))
    ArtRecDonorsMotivations_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-ArtRecDonorsMotivations_FR.csv")))
    ArtRecVolsActivities_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-ArtRecVolsActivities_FR.csv")))
    ArtRecVolsBarriers_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-ArtRecVolsBarriers_FR.csv")))
    ArtRecVolsMotivations_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-ArtRecVolsReasons_FR.csv")))
    ArtRecVolsVolRates_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-ArtRecVolsVolRates_FR.csv")))
    ...
    SubSecDonRatesFoc_2018 = SubSecDonRatesFoc_2018[
        SubSecDonRatesFoc_2018['QuestionText'] == "Arts & recreation"]
    ...
    SubSecVolRatesFoc_2018 = SubSecVolRatesFoc_2018[
        SubSecVolRatesFoc_2018['QuestionText'] == "Arts & recreation"]
...
def process_data(data):
    for i in range(len(data)):
        ...
        data[i]["Attribute"] = np.where(
            data[i]["Attribute"] == "Arts and<br>recreation<br>volunteer",
            "Arts and recreation volunteer",
            data[i]["Attribute"])
        data[i]["Attribute"] = np.where(
            data[i]["Attribute"] == "Arts and<br>recreation<br>donors",
            "Arts and recreation donors",
            data[i]["Attribute"])
        data[i]["Attribute"] = np.where(
            data[i]["Attribute"] == "Arts and<br>recreation<br>donor",
            "Arts and recreation donor",
            data[i]["Attribute"])
        data[i]["Attribute"] = np.where(
            data[i]["Attribute"] == "Non-arts and<br>recreation<br>volunteer",
            "Non-arts and recreation volunteer",
            data[i]["Attribute"])
        data[i]["Attribute"] = np.where(
            data[i]["Attribute"] == "Non-arts and<br>recreation<br>donors",
            "Non-arts and recreation donors",
            data[i]["Attribute"])
        data[i]["Attribute"] = np.where(
            data[i]["Attribute"] == "Non-arts and<br>recreation<br>donor",
            "Non-arts and recreation donor",
            data[i]["Attribute"])
