# App layout file for GV_EO_2018_FR converted from GAV0303_fr.py
        ...
        dbc.Container(
            dbc.Row(
                html.Div(
                    html.Div([
                        html.H1(
                            ("DONS ET BÉNÉVOLAT POUR LES ORGANISMES DU SECTEUR DE L’ÉdUCATION").capitalize()),
                        # html.Span(
                        #     'David Lasby',
                        #     className='meta'
                        # )
