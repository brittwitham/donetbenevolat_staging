# App layout file for GV_HO_2018_FR converted from GAV0301_fr.py
...
navbar = gen_navbar("giving_and_volunteering_for_health_organizations_2018")
        ...
        dbc.Container(
            dbc.Row(
                html.Div(
                    html.Div([
                        html.H1(
                            ('Dons d’argent et bénévolat pour les organismes santé').capitalize()),
                        # html.Span(
                        #     'David Lasby',
                        #     className='meta'
                        # )
