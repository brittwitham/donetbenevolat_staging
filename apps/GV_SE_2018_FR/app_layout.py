# App layout file for GV_SE_2018_FR converted from GAV0307_fr.py
        ...
        dbc.Container(
            dbc.Row(
                html.Div(
                    html.Div([
                        html.H1(
                            'Les dons et le bénévolat des personnes agées (2018)'),
                        # html.Span(
                        #     'David Lasby',
                        #     className='meta'
                        # )
    ...
    dbc.Container([
        dbc.Row([
            ...
            html.Div([
                ...
                dcc.Graph(
                    id='SeniorsDonRateByCause_fr', style={
                        'marginTop': marginTop}),
                dcc.Markdown("""
                ...
                dcc.Graph(
                    id='SeniorsAvgAmtByCause_fr', style={
                        'marginTop': marginTop}),
            ], className='col-md-10 col-lg-8 mx-auto'),
            html.Div([
                ...
                dcc.Graph(
                    id='SeniorsDonRateByMeth_fr', style={
                        'marginTop': marginTop}),
                dcc.Markdown("""
                ...
                dcc.Graph(
                    id='SeniorsAvgAmtByMeth_fr', style={
                        'marginTop': marginTop}),
            ], className='col-md-10 col-lg-8 mx-auto'
            ),
            html.Div([
                ...
                dcc.Graph(
                    id='SeniorsMotivations_fr', style={
                        'marginTop': marginTop}),
            ], className='col-md-10 col-lg-8 mx-auto'
            ),
            html.Div([
                ...
                html.Div([
                    ...
                    dcc.Graph(
                        id='SeniorsSolicitations_fr', style={
                            'marginTop': 50}),
                ]),
            ], className='col-md-10 col-lg-8 mx-auto'
            ),
        ...
        dbc.Row([
            html.Div([
                ...
                dcc.Graph(
                    id='SeniorsVolRateVolAmt_fr', style={
                        'marginTop': marginTop}),
            ], className='col-md-10 col-lg-8 mx-auto'
            ),
            html.Div([
                ...
                dcc.Graph(
                    id='SeniorsVolRateByCause_fr', style={
                        'marginTop': marginTop}),
                dcc.Markdown("""
                ...
                dcc.Graph(
                    id='SeniorsAvgHrsByCause_fr', style={
                        'marginTop': marginTop}),
            ], className='col-md-10 col-lg-8 mx-auto'),
            html.Div([
                ...
                dcc.Graph(
                    id='SeniorsVolRateByActivity_fr', style={
                        'marginTop': marginTop}),
                dcc.Markdown("""
                ...
                dcc.Graph(
                    id='SeniorsAvgHrsByActivity_fr', style={
                        'marginTop': marginTop}),
            ...
            html.Div([
                ...
                dcc.Graph(
                    id='SeniorsVolMotivations_fr', style={
                        'marginTop': marginTop}),
            ], className='col-md-10 col-lg-8 mx-auto'
            ),
            html.Div([
                ...
                dcc.Graph(
                    id='SeniorsVolBarriers_fr', style={
                        'marginTop': marginTop}),
            ], className='col-md-10 col-lg-8 mx-auto'
            ),
            html.Div([
                ...
                dcc.Graph(
                    id='SeniorsRateHelpDirect_fr', style={
                        'marginTop': marginTop}),
                dcc.Markdown("""
                ...
                dcc.Graph(
                    id='SeniorsHrsHelpDirect_fr', style={
                        'marginTop': marginTop}),
            ], className='col-md-10 col-lg-8 mx-auto'
            ),
            html.Div([
                ...
                dcc.Graph(
                    id='SeniorsRateCommInvolve_fr', style={
                        'marginTop': marginTop}),
                dcc.Markdown("""
                ...
                dcc.Graph(
                    id='SeniorsHrsCommInvolve_FR', style={
                        'marginTop': marginTop}),
            ], className='col-md-10 col-lg-8 mx-auto'
            ),
        ]),
