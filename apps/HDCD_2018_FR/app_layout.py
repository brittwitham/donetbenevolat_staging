# App layout file for HDCD_2018_FR converted from
...
navbar = gen_navbar("How_do_Canadians_donate_2018")
        ...
        dbc.Row([
            ...
            html.Div(
                [
                    ...
                    dcc.Graph(
                        id='DonMethDonRateAvgDonAmt-Method',
                        style={
                            'marginTop': marginTop}),
                ], className='col-md-10 col-lg-8 mx-auto'
            ),
                ...
                [
                    ...
                    html.Div([
                        ...
                        html.Div([
                            ...
                            dcc.Graph(
                                id='DonMethDonRateAvgDonAmt-Gndr',
                                style={
                                    'marginTop': marginTop}),
                        ]),
                    ]),
                    ...
                    html.Div([
                        ...
                        html.Div([
                            ...
                            dcc.Graph(
                                id='DonMethDonRateAvgDonAmt-Age',
                                style={
                                    'marginTop': marginTop}),
                        ]),
                    ]),
                    ...
                    html.Div([
                        ...
                        html.Div([
                            ...
                            dcc.Graph(
                                id='DonMethDonRateAvgDonAmt-Educ',
                                style={
                                    'marginTop': marginTop}),
                        ]),
                    ]),
                    ...
                    html.Div([
                        ...
                        html.Div([
                            ...
                            dcc.Graph(
                                id='DonMethDonRateAvgDonAmt-Inc',
                                style={
                                    'marginTop': marginTop}),
                        ]),
                    ]),
                    ...
                    html.Div([
                        ...
                        html.Div([
                            # html.H6("Donation rate & average donation amount by household income"),
                            dcc.Graph(
                                id='DonMethDonRateAvgDonAmt-Relig',
                                style={
                                    'marginTop': marginTop}),
                        ]),
                    ]),
