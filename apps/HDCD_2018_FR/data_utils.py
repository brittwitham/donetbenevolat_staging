...
def get_data():
    ...
    DonMethAvgDon_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-DonMethAvgDon_FR.csv")))
    DonMethDonRates_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-DonMethDonRates_FR.csv")))
