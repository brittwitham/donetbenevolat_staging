...
def get_data():
    ...
    VolRate_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-VolRate_FR.csv")))
    CommInvolveHrs_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-CommInvolveHrs_FR.csv")))
    CommInvolveRate_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-CommInvolveRate_FR.csv")))
    HelpDirectHrs_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-HelpDirectHrs_FR.csv")))
    HelpDirectRate_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-HelpDirectRate_FR.csv")))
    FormsVolunteering_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-FormsVolunteering-updated_FR.csv")))
