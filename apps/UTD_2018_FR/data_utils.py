...
def get_data():
    ...
    TopDonorsMotivations_2018 = pd.read_csv(os.path.abspath(
        filepath.format("2018-TopDonorsMotivationsForGiving_FR.csv")))
    TopDonorsBarriers_2018 = pd.read_csv(os.path.abspath(
        filepath.format("2018-TopDonorsBarriersToGiving_FR.csv")))
    TopDonorsPercTotDonations_2018 = pd.read_csv(os.path.abspath(
        filepath.format("2018-TopDonorsPercTotDonations_FR.csv")))
    TopDonorsPercTotDonors_2018 = pd.read_csv(os.path.abspath(
        filepath.format("2018-TopDonorsPercTotDonors_FR.csv")))
    TopDonorsDonRates_2018 = pd.read_csv(os.path.abspath(
        filepath.format("2018-TopDonorsDonRates_FR.csv")))
    TopDonorsDemoLikelihoods = pd.read_csv(os.path.abspath(
        filepath.format("2018-TopDonorsDemoLikelihoods_FR.csv")))
