# Callbacks file for UTV_2018_FR converted from
...
def register_callbacks(app):
    ...
    def update_graph(region):
        ...
        title = '{}, {}'.format(
            "Répartition des heures de bénévolat totales", region)
    ...
    def update_graph(region, demo):
        ...
        title = '{}, {}'.format(
            "Probabilité d'être un.e bénévole très engagé.e selon " +
            str(demo).lower(),
            region)
    ...
    def update_graph(region):
        ...
        title = '{}, {}'.format(
            "Niveaux de soutien selon la cause, bénévoles très engagé.e.s et autres bénévoles ",
            region)
    ...
    def update_graph(region):
        ...
        title = '{}, {}'.format(
            "Motivations du bénévolat, bénévoles très engagé.e.s et autres bénévoles",
            region)
        return vertical_percentage_graph(dff, title, name1, name2)
    ...
    def update_graph(region):
        ...
        title = '{}, {}'.format(
            "Freins empêchant de faire plus de bénévolat, bénévoles <br> très engagé.e.s et autres bénévoles",
            region)
        return vertical_percentage_graph(dff, title, name1, name2)
