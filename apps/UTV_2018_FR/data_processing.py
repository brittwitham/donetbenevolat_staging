# Data processing file for UTV_2018_FR converted from
...
data = [
    TopVolsMotivations_2018,
    TopVolsBarriers_2018,
    TopVolsPercTotHours_2018,
    TopVolsPercTotVols_2018,
    TopVolsVolRates_2018,
    TopVolsDemoLikelihoods]
