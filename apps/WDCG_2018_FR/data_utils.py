...
def get_data():
    ...
    Reasons_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-ReasonsForGiving_FR.csv")))
    AvgAmtReasons_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-AvgAmtMotivations_FR.csv")))
    MotivationsByCause_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-MotivationsByCause_FR.csv")))
