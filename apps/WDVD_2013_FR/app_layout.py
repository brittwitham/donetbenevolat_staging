# App layout file for WDVD_2013_FR converted from WDV020213_fr.py
        ...
        dbc.Container(
                dbc.Row(
                    html.Div(
                        html.Div([
                            html.H1(
                                'Quelles sont les activités des bénévoles? (2013)'),
                            # html.Span(
                            #     'David Lasby',
                            #     className='meta'
                            # )
    ...
    dbc.Container(
        dbc.Row([
            ...
            html.Div([
                ...
                dcc.Graph(
                    id='ActivitiesVolRateAvgHrs_13', style={
                        'marginTop': 20}),
            ], className='col-md-10 col-lg-8 mx-auto'
            ),
            ...
            html.Div(
                [
                    ...
                    html.Div([
                        ...
                        dcc.Graph(id='ActivityVolRate-MarStat_13',
