...
def get_data():
    ...
    ActivityVolRate_2018 = pd.read_csv(op.abspath(
        filepath.format("2013-ActivityVolRate_FR.csv")))
    AvgHoursVol_2018 = pd.read_csv(op.abspath(
        filepath.format("2013-AvgHoursVol_FR.csv")))
