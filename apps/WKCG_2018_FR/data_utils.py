...
def get_data():
    ...
    Barriers_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-BarriersToGiving_FR.csv")))
    AvgAmtBarriers_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-AvgAmtBarriers_FR.csv")))
    GivingConcerns_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-GivingConcerns_FR.csv")))
    SolicitationConcerns_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-SolicitationConcerns_FR.csv")))
    BarriersByCause_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-BarriersByCause_FR.csv")))
