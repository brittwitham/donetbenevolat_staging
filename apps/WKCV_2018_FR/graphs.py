...
def vertical_percentage_graph_volunteers(dff, title, by="Attribute"):
    ...
    dff['HoverText'] = np.select([dff["Marker"] == "*", dff["Marker"] == "...", pd.isnull(dff["Marker"])], ["Estimate: " +
                                                                                                            ...
                                                                                                            (dff["CI Upper"] -
                                                                                                             dff["Estimate"]).map(str) +
                                                                                                            "%<br><b>A utiliser avec précaution</b>", "Estimate Suppressed", "Estimate: " +
                                                                                                            dff.Estimate.map(str) +
                                                                                                            "% ± " +
                                                                                                            (dff["CI Upper"] -
                                                                                                                dff["Estimate"]).map(str) +
        ...
        fig.update_layout(
            ...
            annotations=[
                dict(
                    ...
                    showarrow=False),
                dict(
                    text="*<i>A utiliser avec précaution<br>Certains résultats sont pas assez fiables pour être affichés</i>",
                    xref="paper",
                    yref="paper",
                    xanchor='right',
                    yanchor="top",
        ...
        fig.update_layout(
            ...
            annotations=[
                dict(
                    ...
                    showarrow=False),
                dict(
                    text="*<i>A utiliser avec précaution</i>",
                    xref="paper",
                    yref="paper",
                    xanchor='right',
                    yanchor="top",
