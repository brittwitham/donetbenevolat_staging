...
def get_data():
    ...
    VolRate_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-VolRate-FR-updated.csv")))
    AvgTotHours_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-AvgTotHours-FR-updated.csv")))
    FormsVolunteering_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-FormsVolunteering_FR.csv")))
    PercTotVols_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-PercTotVolunteers-updated_FR.csv")))
    ...
    PercTotHours_2018 = pd.read_csv(op.abspath(
        filepath.format("2018-PercTotHours_FR.csv")))
