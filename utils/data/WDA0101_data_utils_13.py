...
def get_data():
    ...
    FormsGiving_2018 = pd.read_csv(op.abspath(filepath.format("2013-FormsGiving_FR.csv")))
    ...
    FR_TopCauseFocus_2018['Estimate'] = FR_TopCauseFocus_2018['Estimate']*100
    FR_TopCauseFocus_2018['CI Upper'] = FR_TopCauseFocus_2018['CI Upper']*100
    ...
    return DonRates_2018, AvgTotDon_2018, FR_AvgNumCauses_2018, FormsGiving_2018, FR_TopCauseFocus_2018, PropTotDon_2018, PropTotDonAmt_2018
