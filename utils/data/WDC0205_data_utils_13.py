...
def get_data():
    ...
    ReasonsVol_2018 = pd.read_csv(op.abspath(filepath.format("2013-ReasonsForVolunteering_FR.csv")))
    AvgHrsReasons_2018 = pd.read_csv(op.abspath(filepath.format("2013-AvgHoursMotivations_FR.csv")))
    MotivationsVolByCause_2018 = pd.read_csv(op.abspath(filepath.format("2013-MotivationsVolByCause_FR.csv")))
