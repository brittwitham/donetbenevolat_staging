...
def get_data():
    ...
    Barriers_2018 = pd.read_csv(op.abspath(filepath.format("2013-BarriersToGiving_FR.csv")))
    AvgAmtBarriers_2018 = pd.read_csv(op.abspath(filepath.format("2013-AvgAmtBarriers_FR.csv")))
    GivingConcerns_2018 = pd.read_csv(op.abspath(filepath.format("2013-GivingConcerns_FR.csv")))
    SolicitationConcerns_2018 = pd.read_csv(op.abspath(filepath.format("2013-SolicitationConcerns_FR.csv")))
    BarriersByCause_2018 = pd.read_csv(op.abspath(filepath.format("2013-BarriersByCause_FR.csv")))
