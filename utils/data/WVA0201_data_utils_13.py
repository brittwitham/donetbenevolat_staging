...
def get_data():
    ...
    FormsVolunteering_2018 = pd.read_csv(op.abspath(filepath.format("2013-FormsVolunteering_FR.csv")))
    # PercTotVols_2018 = pd.read_csv(op.abspath(filepath.format("2018-PercTotVolunteers-updated_FR.csv")))
    PercTotVols_2018 = pd.read_csv(op.abspath(filepath.format("2013-PercTotPopn_FR.csv")))
    # PercTotVols_2018 = pd.read_csv('tables/2018-PercTotVolunteers-updated.csv', encoding = 'unicode_escape', engine ='python')
    PercTotHours_2018 = pd.read_csv(op.abspath(filepath.format("2013-PercTotHours_FR.csv")))
