...
EducDonorsBarriers_2018 = pd.read_csv("../tables/2018-EducDonorsBarriers.csv")
EducDonorsDonMeth_2018 = pd.read_csv("../tables/2018-EducDonorsDonMeth.csv")
EducDonorsDonRates_2018 = pd.read_csv("../tables/2018-EducDonorsDonRates.csv")
EducDonorsMotivations_2018 = pd.read_csv("../tables/2018-EducDonorsMotivations.csv")
EducVolsActivities_2018 = pd.read_csv("../tables/2018-EducVolsActivities.csv")
EducVolsBarriers_2018 = pd.read_csv("../tables/2018-EducVolsBarriers.csv")
EducVolsMotivations_2018 = pd.read_csv("../tables/2018-EducVolsReasons.csv")
EducVolsVolRates_2018 = pd.read_csv("../tables/2018-EducVolsVolRates.csv")
...
app.layout = html.Div([
    html.Div([
        html.H1('Giving and Volunteering for Education & Research Organizations')]),
    html.Div([
    ...
    html.Div([
        ...
        dcc.Graph(id='EducDonsCauses', style={'marginTop': 50}),
        dcc.Graph(id='EducDonsMeth', style={'marginTop': 50}),
        dcc.Graph(id='EducMotivations', style={'marginTop': 50}),
        dcc.Graph(id='EducBarriers', style={'marginTop': 50}),
        dcc.Graph(id='VolRateAvgHrs', style={'marginTop': 50}),
        dcc.Graph(id='EducHrsCauses', style={'marginTop': 50}),
        dcc.Graph(id='EducVolActivity', style={'marginTop': 50}),
        dcc.Graph(id='EducVolMotivations', style={'marginTop': 50}),
        dcc.Graph(id='EducVolBarriers', style={'marginTop': 50})
    ],
