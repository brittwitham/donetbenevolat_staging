...
ActivityVolRate_2013 = pd.read_csv("../tables/2013-ActivityVolRate.csv")
AvgHoursVol_2013 = pd.read_csv("../tables/2013-AvgHoursVol.csv")

ActivityVolRate_2013['Estimate'] = ActivityVolRate_2013['Estimate']*100
ActivityVolRate_2013['CI Upper'] = ActivityVolRate_2013['CI Upper']*100

data = [ActivityVolRate_2013, AvgHoursVol_2013]
...
activity_names = ActivityVolRate_2013.QuestionText.unique()
...
def update_graph(region):
    ...
    dff1 = ActivityVolRate_2013[ActivityVolRate_2013['Region'] == region]
    dff1 = dff1[dff1['Group'] == "All"]
    name1 = "% volunteering"

    dff2 = AvgHoursVol_2013[AvgHoursVol_2013['Region'] == region]
...
def update_graph(region, activity):
    dff = ActivityVolRate_2013[ActivityVolRate_2013['Region'] == region]
    dff = dff[dff['QuestionText'] == activity]
    dff = dff[dff['Group'] == "Sex"]

    title = '{}, {}'.format("Volunteer rate by activity by sex", region)
