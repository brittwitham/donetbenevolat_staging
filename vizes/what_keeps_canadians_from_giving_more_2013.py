...
# DonMethAvgDon_2013 = pd.read_csv(op.abspath(filepath.format("2013-BarriersToGiving.csv")))
Barriers_2013 = pd.read_csv(op.abspath(filepath.format("2013-BarriersToGiving.csv")))
AvgAmtBarriers_2013 = pd.read_csv(op.abspath(filepath.format("2013-AvgAmtBarriers.csv")))
GivingConcerns_2013 = pd.read_csv(op.abspath(filepath.format("2013-GivingConcerns.csv")))
SolicitationConcerns_2013 = pd.read_csv(op.abspath(filepath.format("2013-SolicitationConcerns.csv")))
BarriersByCause_2013 = pd.read_csv(op.abspath(filepath.format("2013-BarriersByCause.csv")))

# Barriers_2013 = pd.read_csv("../Tables/2013-BarriersToGiving.csv")
# AvgAmtBarriers_2013 = pd.read_csv("../Tables/2013-AvgAmtBarriers.csv")
# GivingConcerns_2013 = pd.read_csv("../Tables/2013-GivingConcerns.csv")
# SolicitationConcerns_2013 = pd.read_csv("../Tables/2013-SolicitationConcerns.csv")
# BarriersByCause_2013 = pd.read_csv("../Tables/2013-BarriersByCause.csv")

Barriers_2013['Estimate'] = Barriers_2013['Estimate'] * 100
Barriers_2013['CI Upper'] = Barriers_2013['CI Upper'] * 100
GivingConcerns_2013['Estimate'] = GivingConcerns_2013['Estimate'] * 100
GivingConcerns_2013['CI Upper'] = GivingConcerns_2013['CI Upper'] * 100
SolicitationConcerns_2013['Estimate'] = SolicitationConcerns_2013['Estimate'] * 100
SolicitationConcerns_2013['CI Upper'] = SolicitationConcerns_2013['CI Upper'] * 100
BarriersByCause_2013['Estimate'] = BarriersByCause_2013['Estimate'] * 100
BarriersByCause_2013['CI Upper'] = BarriersByCause_2013['CI Upper'] * 100

data = [Barriers_2013, AvgAmtBarriers_2013, GivingConcerns_2013, SolicitationConcerns_2013, BarriersByCause_2013]

cause_names = BarriersByCause_2013["Group"].unique()
barriers_names = Barriers_2013["QuestionText"].unique()
...
def update_graph(region):
    dff = Barriers_2013[Barriers_2013['Region'] == region]
...
def update_graph(region):
    dff = AvgAmtBarriers_2013[AvgAmtBarriers_2013['Region'] == region]
...
def update_graph(region):
    dff = GivingConcerns_2013[GivingConcerns_2013['Region'] == region]
    dff = dff[dff["Group"] == "All"]
...
def update_graph(region):
    dff = SolicitationConcerns_2013[SolicitationConcerns_2013['Region'] == region]
    dff = dff[dff["Group"] == "All"]
...
def update_graph(region, barrier):
    ...
    title = '{}, {}'.format("Barriers to giving more by sex", region)
...
def update_graph(region, cause):
    dff = BarriersByCause_2013[BarriersByCause_2013['Region'] == region]
