...
VolRate_2013 = pd.read_csv(op.abspath(filepath.format("2013-VolRate.csv")))
AvgTotHours_2013 = pd.read_csv(op.abspath(filepath.format("2013-AvgTotHours.csv")))
FormsVolunteering_2013 = pd.read_csv(op.abspath(filepath.format("2013-FormsVolunteering.csv")))
# PercTotVols_2013 = pd.read_csv(op.abspath(filepath.format("2013-PercTotVolunteers.csv")))
# PercTotHours_2013 = pd.read_csv(op.abspath(filepath.format("2013-PercTotHours.csv")))

# VolRate_2013 = pd.read_csv("https://raw.githubusercontent.com/ajah/statscan_data_portal/master/Tables/2013-VolRate.csv")
# VolRate_2013 = pd.read_csv("./tables/2013-VolRate.csv")
# # AvgTotHours_2013 = pd.read_csv("https://raw.githubusercontent.com/ajah/statscan_data_portal/master/Tables/2013-AvgTotHours.csv")
# AvgTotHours_2013 = pd.read_csv("./tables/2013-AvgTotHours.csv")
# FormsVolunteering_2013 = pd.read_csv("./tables/2013-FormsVolunteering.csv")
# PercTotVols_2013 = pd.read_csv("./tables/2013-PercTotVolunteers.csv")
# PercTotHours_2013 = pd.read_csv("./tables/2013-PercTotHours.csv")

VolRate_2013['Estimate'] = VolRate_2013['Estimate']*100
VolRate_2013['CI Upper'] = VolRate_2013['CI Upper']*100
FormsVolunteering_2013['Estimate'] = FormsVolunteering_2013['Estimate']*100
FormsVolunteering_2013['CI Upper'] = FormsVolunteering_2013['CI Upper']*100
# PercTotVols_2013['Estimate'] = PercTotVols_2013['Estimate']*100
# PercTotVols_2013['CI Upper'] = PercTotVols_2013['CI Upper']*100
# PercTotHours_2013['Estimate'] = PercTotHours_2013['Estimate']*100
# PercTotHours_2013['CI Upper'] = PercTotHours_2013['CI Upper']*100

data = [VolRate_2013,
        AvgTotHours_2013,
        # PercTotVols_2013,
        # PercTotHours_2013,
        FormsVolunteering_2013]
...
fig1df1 = VolRate_2013[VolRate_2013['Group'] == "All"]
fig1df1 = fig1df1[fig1df1.Province.notnull()]

fig1df2 = AvgTotHours_2013[AvgTotHours_2013['Group'] == "All"]
...
def update_graph(region):
    ...
    dff1 = FormsVolunteering_2013[FormsVolunteering_2013['Region'] == region]
...
def update_graph(region):
    ...
    dff1 = VolRate_2013[VolRate_2013['Region'] == region]
    dff1 = dff1[dff1['Group'] == "Age group"]
    name1 = "Volunteer rate"


    dff2 = AvgTotHours_2013[AvgTotHours_2013['Region'] == region]
...
def update_graph(region):
    ...
    title = '{}, {}'.format("Volunteer rate & average hours volunteered by sex", region)
...
#
# def update_graph(region):
#     dff1 = PercTotVols_2013[PercTotVols_2013['Region'] == region]
#     dff1 = dff1[dff1['Group'] == "Age group"]
#     name1 = "% volunteers"
#
#
#     dff2 = PercTotHours_2013[PercTotHours_2013['Region'] == region]
#     dff2 = dff2[dff2['Group'] == "Age group"]
...
#     name2 = "% volunteer hours"
#
#     title = '{}, {}'.format("Percentage of Canadians & total hours volunteered by sex", region)
#
#     return perc_don_perc_amt(dff1, dff2, name1, name2, title)
