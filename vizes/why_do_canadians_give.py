...
Reasons_2018 = pd.read_csv(op.abspath(filepath.format("2018-ReasonsForGiving.csv")))
AvgAmtReasons_2018 = pd.read_csv(op.abspath(filepath.format("2018-AvgAmtMotivations.csv")))
MotivationsByCause_2018 = pd.read_csv(op.abspath(filepath.format("2018-MotivationsByCause.csv")))
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Graph(id='MotivationsAvgAmts', style={'marginTop': 50}),
        html.Div([
            html.Div(["Select a motivation of focus:",
                      dcc.Dropdown(
                          ...
                          value='Was asked by someone familiar',
                          style={'verticalAlgin': 'middle'}
                      ),
                      ],
...
def update_graph(region, motivation):
    ...
    title = '{}, {}'.format("Donor motivations by gender", region)
