...
ReasonsVol_2018 = pd.read_csv("../tables/2018-ReasonsForVolunteering.csv")
AvgHrsReasons_2018 = pd.read_csv("../tables/2018-AvgHoursMotivations.csv")
MotivationsVolByCause_2018 = pd.read_csv("../tables/2018-MotivationsVolByCause.csv")
        ...
        html.Div([
            html.Div(["Select a motivation of focus:",
                      dcc.Dropdown(
                          ...
                          value='Personally affected by cause',
                          style={'verticalAlgin': 'middle'}
                      ),
                      ],
...
def update_graph(region):
    dff = AvgHrsReasons_2018[AvgHrsReasons_2018['Region'] == region]
...
def update_graph(region, motivation):
    ...
    title = '{}, {}'.format("Volunteer motivations by gender", region)
